...
const advancements = [
  ...
  new Advancement(
    'HighActiveCPS',
    'Are you really autoclicking right now...',
    () => cpsCountSpan.dataset.value / Math.max(1, shopItems.clickPerClick.calc.getIncrease() - 1) - shopItems.autoClick.calc.getIncrease() >= 50
  )
];
